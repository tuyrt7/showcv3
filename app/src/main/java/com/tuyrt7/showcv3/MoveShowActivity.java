...
public class MoveShowActivity extends Activity implements CvCameraViewListener2, OnSeekBarChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_move_show);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame)
    {
        ...
        //TODO 判断contours 的size 有无，来决定是否有运动物体经过
        Log.d("NICK", "-----------contours:" + contours.size()); // 大于10 的情况下算有物体经过
        return mRgb;
    }
